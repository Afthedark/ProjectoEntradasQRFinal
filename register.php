  ...
  <body>
    <div class="page login-page">
                ...
                <div class="content">
                  <form class="form-validate">
                    ...
                    <div class="form-group terms-conditions">
                      ...
                      <label for="register-agree">Enviar datos para registrar</label>
                    </div>
                    <div class="form-group">
                      <button id="regidter" type="submit" name="registerSubmit" class="btn btn-primary">Registrar</button>
                      <a href="index.php" class="btn btn-primary" role="button">Cancelar</a>
                    </div>
                  </form><small>¿Ya tienes una cuenta? </small><a href="index.php" class="signup">Inicia sesión</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="copyrights text-center">
        <p> <a href="https://bootstrapious.com" class="external"></a>
